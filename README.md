...
4. 文件/文件夹命名:编号\_名称\_实现方式\_所用数据\_备注\_待完成?\_重要?_环境(难以区分时使用OOO进行分隔,+表示任意字符,xxx表示任何内容,&表示多项组合)
    * a\_example1\_sklearn&pytorch\_mnist\_多分类问题\_ing\_erOOOpytorch_env.ipynb
